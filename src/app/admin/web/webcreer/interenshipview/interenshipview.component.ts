...
declare var $: any;
@Component({
  selector: 'app-interenshipview',
  templateUrl: './interenshipview.component.html',
  styleUrls: ['./interenshipview.component.css']
})


export class InterenshipviewComponent implements OnInit {
